...
const normalizeAttendance = (record) => ({
  ...
  checkInPhotoProvider: record.checkInPhotoProvider,
  checkInPhotoPublicId: record.checkInPhotoPublicId,
  checkInPhotoResourceType: record.checkInPhotoResourceType,
