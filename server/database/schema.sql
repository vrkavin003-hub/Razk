...
CREATE TABLE IF NOT EXISTS attendance (
  ...
  check_in_location_status ENUM('Inside', 'Outside', 'Unknown') NOT NULL DEFAULT 'Unknown',
  check_in_distance_meters INT UNSIGNED NULL,
  check_out_time DATETIME NULL,
  check_out_latitude DECIMAL(10,7) NULL,
  check_out_longitude DECIMAL(10,7) NULL,
  check_out_location_status ENUM('Inside', 'Outside', 'Unknown') NOT NULL DEFAULT 'Unknown',
